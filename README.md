...
PicoSAM2 comes with an automated setup script `init.sh` to get everything ready in one step. It:
...
- Creates a Python virtual environment (`picosam2_env/`)  
- Installs all required dependencies from `requirements.txt`  
- Installs the PicoSAM2 project into the environment  
...
python3 picosam2_model_distillation.py        # Distill student from SAM2
python3 picosam2_train_from_scratch.py        # Train supervised baseline
python3 benchmark.py                          # Evaluate mIoU, mAP
python3 plot_size_comparison.py               # Plot model size
python3 imx500_converter.py                   # Export ONNX for IMX500
```
